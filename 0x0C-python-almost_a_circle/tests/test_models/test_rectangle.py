...
class TestRectangle_width(unittest.TestCase):
    ...
    def test_bool_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(True, 2)
OB
OB    def test_list_width(self):
OB        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle([1, 2, 3], 2)
OB
OB    def test_set_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
OB            Rectangle({1, 2, 3}, 2)

    def test_tuple_width(self):
OB        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle((1, 2, 3), 2)

OB    def test_frozenset_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
...
OB    def test_bytes_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
OBOB            Rectangle(b'Python', 2)

OBOBOBOBOB    def test_bytearray_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
...
OB        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            Rectangle(-1, 2)
